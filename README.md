...
- Supabase migration files through `20260717223357_lock_set_updated_at_search_path.sql`; remote migration status is tracked in `docs/11_SUPABASE_REMOTE_STATUS.md`.
