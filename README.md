...
- Supabase migration files through `20260619194631_generated_session_identity_lifecycle.sql`; remote migration status is tracked in `docs/11_SUPABASE_REMOTE_STATUS.md`.
