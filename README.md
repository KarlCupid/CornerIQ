...
- Supabase migration files through `20260620000100_workout_completion_retry_integrity.sql`; remote migration status is tracked in `docs/11_SUPABASE_REMOTE_STATUS.md`.
