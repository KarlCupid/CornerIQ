...
- Supabase migration files through `20260625080657_generated_session_active_slot_reconciliation.sql`; remote migration status is tracked in `docs/11_SUPABASE_REMOTE_STATUS.md`.
