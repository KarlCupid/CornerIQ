...
- Supabase migration files through `20260626062900_revision_isolated_plan_lifecycle.sql`; remote migration status is tracked in `docs/11_SUPABASE_REMOTE_STATUS.md`.
