...
- Supabase migration files through `20260723233725_align_next_week_volume_strategy.sql`; remote migration status is tracked in `docs/11_SUPABASE_REMOTE_STATUS.md`.
