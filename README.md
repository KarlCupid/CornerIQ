...
- Supabase migration files through `014_temporal_integrity_session_resolution.sql`; remote migration status is tracked in `docs/11_SUPABASE_REMOTE_STATUS.md`.
