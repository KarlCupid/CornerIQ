...
- Supabase migration files through `20260718092403_remove_obsolete_medical_profile_data.sql`; remote migration status is tracked in `docs/11_SUPABASE_REMOTE_STATUS.md`.
