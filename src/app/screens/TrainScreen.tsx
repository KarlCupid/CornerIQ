    ...
    <View style={{ gap: spacing.lg }} testID="train-manual-logger-section">
      <EngineCard>
        <View style={{ gap: spacing.sm }}>
          ...
          <Text style={screenStyles.subtle}>Use this for boxing class, roadwork, protected sparring you already do, or strength work not generated by CornerIQ.</Text>
  ...
  return (
    <EngineCard>
      <View style={{ gap: spacing.sm }} testID="train-weekly-generated-work">
        ...
        <Text style={screenStyles.body}>{generation.athleteFacingWeekSummary}</Text>
        ...
        {viewModel.weeklyWorkoutCards.length > 0 ? viewModel.weeklyWorkoutCards.map((session) => (
          <View key={session.id} style={{ gap: spacing.xs }}>
            ...
            <Text style={screenStyles.body}>{session.sessionTypeLabel ?? "Generated training"}: {session.title}</Text>
    ...
    <LuminousScreen testID="train-screen">
      ...
      {section === "workout" ? (
        <View style={{ gap: spacing.lg }} testID="train-workout-section">
          ...
          )) : <EmptyState title="No workout detail today" message="No generated training detail is due today. Future work should not be pulled forward from Plan. Log protected or manual boxing if it happens; otherwise this section can wait." />}
