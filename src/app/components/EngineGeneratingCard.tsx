...
const copyByStatus: Record<Exclude<EngineGenerationStatus, "idle">, { title: string; lines: readonly string[]; testID: string }> = {
  saving_anchors: {
    title: "Saving fixed anchors",
    lines: ["Checking dates, duration, intensity, and protected boxing priority.", "Fixed boxing stays fixed before generated support is placed."],
    testID: "plan-generation-pending"
  },
  generating_plan: {
    title: "Generating your plan",
    lines: ["Checking anchors, availability, readiness, and safety.", "Placing generated support around fixed boxing."],
    testID: "plan-generation-pending"
  },
  amending_plan: {
  ...
  materializing_next_week: {
    ...
    lines: ["Placing generated support around fixed boxing.", "Persisting future day plans without bypassing safety."],
    testID: "plan-generation-pending"
  },
  generating_workout: {
