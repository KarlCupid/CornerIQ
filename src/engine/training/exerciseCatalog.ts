...
const bodyweightSubstitution: ExerciseSubstitution = {
  ...
  reason: "Use a named no-equipment movement when the original option is not appropriate",
  equipmentNeeded: [],
  loadGuidance: "Easy range of motion; breathe through each transition.",
  coachingNotes: ["Easy range", "Stop before compensation"]
};
...
export const exerciseCatalog: readonly CatalogExercise[] = [
  ...
  },
  {
    ...
    name: "Walk lunge with arm sweep",
    category: "warm_up",
    families: ["movement_quality_prep", "strength_lower", "strength_full_body", "hip_ankle_mobility"],
    requiredEquipment: [],
    noviceEligible: true,
    repsText: "2 x 5 each side",
    loadGuidance: "Bodyweight only; keep the lunge short enough to stay balanced.",
    rpeTarget: 3,
    restText: "30 sec",
    coachingNotes: ["Short step", "Sweep the arm without forcing range"],
    boxingTransfer: "Prepares stance length, hip range, and upper-back rotation before boxing or strength work.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["Use a wall or shorten the step if balance is uncertain."],
    stopConditions: ["Stop if knee, hip, ankle, back, or shoulder pain rises."]
  },
  {
    ...
    noviceEligible: true,
    repsText: "2-3 x 5-8",
    loadGuidance: "Use a slow lower and light pause while every rep stays easy to control.",
    rpeTarget: 5,
    rirTarget: 3,
    tempo: "3 sec down, 1 sec pause, stand smooth",
    restText: "60 sec",
    coachingNotes: ["Sit between the feet", "Stand tall without rushing"],
    boxingTransfer: "Builds leg control and stance posture without needing external load.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["Keep range pain-free and avoid grinding reps."],
    stopConditions: ["Stop if knee, hip, back, or balance changes the rep."]
  },
  {
    ...
    noviceEligible: true,
    repsText: "2-3 x 5-8",
    loadGuidance: "Use smooth band tension that lets posture stay tall.",
    rpeTarget: 6,
    rirTarget: 2,
    restText: "75 sec",
    coachingNotes: ["Elbows forward", "Control the bottom"],
    boxingTransfer: "Trains squat posture and leg drive with a simple band setup.",
    substitutions: [
      {
        exerciseId: "tempo_bodyweight_squat",
        name: "Tempo bodyweight squat",
        ...
        equipmentNeeded: [],
        loadGuidance: "Use slow tempo instead of band tension.",
        coachingNotes: ["Pause lightly", "Stand tall"]
      }
    ],
    safetyNotes: ["The band must be secure before starting."],
    stopConditions: ["Stop if the band slips, pain appears, or posture breaks."]
  },
  {
    exerciseId: "reverse_lunge",
    name: "Reverse lunge",
    category: "secondary_strength",
    families: ["strength_lower", "strength_full_body", "hip_ankle_mobility"],
    requiredEquipment: [],
    noviceEligible: true,
    repsText: "2 x 6 each side",
    loadGuidance: "Bodyweight first; step back only as far as balance allows.",
    rpeTarget: 5,
    restText: "45-60 sec",
    coachingNotes: ["Step back quietly", "Keep the front foot rooted"],
    boxingTransfer: "Builds single-leg stance control for level changes and exits.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["Use support for balance if needed."],
    stopConditions: ["Stop if knee, hip, ankle, or back pain rises."]
  },
  {
    exerciseId: "wall_push_up_plus",
    name: "Wall push-up plus",
    category: "durability",
    families: ["shoulder_scap_durability", "strength_upper", "strength_full_body"],
    requiredEquipment: [],
    noviceEligible: true,
    repsText: "2 x 8-10",
    loadGuidance: "Use light pressure into the wall and own the reach at the top.",
    rpeTarget: 4,
    restText: "45 sec",
    coachingNotes: ["Reach without shrugging", "Keep ribs quiet"],
    boxingTransfer: "Teaches shoulder blade reach for a relaxed guard with very low load.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["Keep neck relaxed and pressure easy."],
    stopConditions: ["Stop if shoulder pain, pinching, numbness, or tingling appears."]
  },
  {
    exerciseId: "prone_w",
    name: "Prone W raise",
    ...
    noviceEligible: true,
    repsText: "2 x 6-8",
    loadGuidance: "Bodyweight only with a tiny range and relaxed neck.",
    rpeTarget: 4,
    restText: "45 sec",
    coachingNotes: ["Thumbs up", "Shoulder blades move gently"],
    boxingTransfer: "Supports upper-back control without a band anchor.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["Use a small range and keep the neck neutral."],
  ...
  },
  {
    ...
    requiredEquipment: ["bands"],
    noviceEligible: true,
    repsText: "3 x 4 each side",
    loadGuidance: "Use a light band and move fast only while timing stays clean.",
    rpeTarget: 5,
    restText: "60 sec",
    coachingNotes: ["Hips start the press", "Reset after every rep"],
    boxingTransfer: "Practices hip-to-hand sequencing without throwing an object.",
    substitutions: [
      {
        exerciseId: "step_and_snap_rotation",
        name: "Step-and-snap rotation",
        reason: "No band anchor available",
        equipmentNeeded: [],
        loadGuidance: "Use bodyweight speed only.",
        coachingNotes: ["Small step", "Stop before timing fades"]
      }
    ],
    safetyNotes: ["Anchor the band securely and keep tension light."],
    stopConditions: ["Stop if speed drops, timing fades, the band slips, or pain appears."]
  },
  {
    exerciseId: "dead_bug_reach",
    name: "Dead bug reach",
    category: "durability",
    families: ["trunk_durability", "strength_full_body", "round_based_conditioning"],
    requiredEquipment: [],
    noviceEligible: true,
    repsText: "2 x 5 each side",
    loadGuidance: "Bodyweight only; move slowly while the low back stays comfortable.",
    rpeTarget: 4,
    restText: "30-45 sec",
    coachingNotes: ["Reach long", "Exhale as the arm or leg moves"],
    boxingTransfer: "Builds anti-extension control for guard posture and punching transfer.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["Shorten the reach if the back arches."],
    stopConditions: ["Stop if back pain, hip pain, or breath-holding appears."]
  },
  {
    ...
    requiredEquipment: [],
    noviceEligible: true,
    repsText: "2 x 8 each side",
    loadGuidance: "Use bodyweight or a very light object only if the shoulder stays quiet.",
    rpeTarget: 4,
    restText: "45 sec",
    coachingNotes: ["Elbow stays by ribs", "Rotate slowly"],
    boxingTransfer: "Supports cuff control when a band setup is not available.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["Keep the range small and pain-free."],
    stopConditions: ["Stop if shoulder pain, pinching, numbness, or tingling appears."]
  },
  {
    ...
    name: "Zone 2 bike",
    category: "roadwork",
    families: ["roadwork_zone2", "mobility_recovery_flow"],
    requiredEquipment: ["bike"],
    noviceEligible: true,
    durationText: "15-30 min",
    loadGuidance: "Ride at talk-test effort with smooth cadence and no chasing pace.",
    rpeTarget: 4,
    restText: "Continuous easy effort",
    coachingNotes: ["Talk-test breathing", "Smooth cadence"],
    boxingTransfer: "Builds aerobic support for round recovery with less running impact.",
    substitutions: [
      {
        exerciseId: "brisk_walk_intervals",
        name: "Brisk walk intervals",
        reason: "No bike available",
        equipmentNeeded: [],
        loadGuidance: "Use the same talk-test effort while walking.",
        coachingNotes: ["Stay conversational", "Keep gait smooth"]
      }
    ],
    safetyNotes: ["Keep resistance light enough that breathing remains controlled."],
    stopConditions: ["Stop if breathing, dizziness, pain, or gait quality changes."]
  },
  {
    exerciseId: "brisk_walk_intervals",
    name: "Brisk walk intervals",
    category: "roadwork",
    families: ["roadwork_zone2", "recovery_reset"],
    requiredEquipment: [],
    noviceEligible: true,
    durationText: "10-20 min",
    loadGuidance: "Walk at talk-test effort and slow down before gait changes.",
    rpeTarget: 3,
    restText: "Walk easy whenever breathing rises",
    coachingNotes: ["Talk-test breathing", "Smooth steps"],
    boxingTransfer: "Keeps aerobic rhythm available without adding running impact.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["Stay on a safe surface and keep effort easy."],
    stopConditions: ["Stop if dizziness, pain, breathing, or gait quality changes."]
  },
  {
  ...
  },
  {
    ...
    name: "Bodyweight hip-hinge reach",
    category: "main_strength",
    families: ["strength_lower", "strength_full_body", "movement_quality_prep"],
    requiredEquipment: [],
    noviceEligible: true,
    repsText: "2-3 x 6",
    loadGuidance: "Push the hips back and reach forward slowly without loading the back.",
    rpeTarget: 4,
    rirTarget: 3,
    tempo: "slow reach, smooth stand",
    restText: "45 sec",
    coachingNotes: ["Hips back", "Back stays long", "Stand tall after each reach"],
    boxingTransfer: "Teaches hinge position for stance braking and hip-driven transfer before loading.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["Use a small range until the hinge feels clear."],
    stopConditions: ["Stop if back pain, hamstring pain, or balance changes the reach."]
  },
  {
  ...
  },
  {
    ...
    name: "Side rockback",
    category: "mobility",
    families: ["strength_lower", "hip_ankle_mobility", "mobility_recovery_flow"],
    requiredEquipment: [],
    noviceEligible: true,
    repsText: "2 x 5 each side",
    loadGuidance: "Use gentle side-to-side range and stop before stretch turns sharp.",
    rpeTarget: 2,
    restText: "30 sec",
    coachingNotes: ["Move slowly", "Stay in pain-free range"],
    boxingTransfer: "Restores lateral stance range for pivots and angle changes without forcing depth.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["Keep the movement easy and non-fatiguing."],
    stopConditions: ["Stop if hip, groin, knee, or back pain rises."]
  },
  {
  ...
  },
  {
    ...
    requiredEquipment: [],
    noviceEligible: true,
    repsText: "2 x 10-20 sec",
    loadGuidance: "Use gentle self-resisted pull and stop before grip or neck tension rises.",
    rpeTarget: 4,
    restText: "45 sec",
    coachingNotes: ["Pull gently", "Neck relaxed", "Ribs quiet"],
    boxingTransfer: "Gives upper-back support when no dumbbell or band anchor is available.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["Do not strain against the towel or hold your breath."],
    stopConditions: ["Stop if neck, shoulder, hand, numbness, tingling, or cramping symptoms appear."]
  },
  {
  ...
  },
  {
    ...
    requiredEquipment: [],
    noviceEligible: true,
    durationText: "2-3 min",
    loadGuidance: "Write one observation and one simpler cue for next time; do not add work.",
    rpeTarget: 1,
    restText: "No extra work after the note.",
    coachingNotes: ["One sentence is enough", "Simplify the next exposure"],
    boxingTransfer: "Preserves one useful technical lesson without adding fatigue or pressure.",
    substitutions: [bodyweightSubstitution],
    safetyNotes: ["The note is for reducing complexity, not judging the session."],
    stopConditions: ["Stop if the review creates stress or pressure to add extra work."]
  },
  {
    exerciseId: "incline_push_up",
    name: "Incline push-up",
