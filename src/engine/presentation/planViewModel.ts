...
export function buildPlanViewModel(state: PerformanceState): PlanViewModel {
  ...
  return {
    ...
    generationAudit: {
      ...
      optionalAddOnBlocks: state.training.supportGenerationAudit.optionalAddOnBlocks,
      ...
      athleteQualityCues: state.training.supportGenerationAudit.athleteQualityCues,
      sessionQualityCheckpoints: state.training.supportGenerationAudit.sessionQualityCheckpoints,
      selfCheckCues: state.training.supportGenerationAudit.selfCheckCues,
      boxingDevelopmentThemeId: state.training.supportGenerationAudit.boxingDevelopmentThemeId,
      boxingDevelopmentThemeTitle: state.training.supportGenerationAudit.boxingDevelopmentThemeTitle,
      athleteFacingThemePurpose: state.training.supportGenerationAudit.athleteFacingThemePurpose,
      targetSkillProgression: state.training.supportGenerationAudit.targetSkillProgression,
      athleteFacingWeekSummary: state.training.supportGenerationAudit.athleteFacingWeekSummary,
