...
export const ENGINE_EVIDENCE_REGISTRY: readonly EngineEvidenceEntry[] = [
  {
    ...
    functions: ["scoreManualCheckIn", "resolveReadiness"],
  ...
  },
  {
    ...
    functions: ["detectUnderFuelingRisk", "estimateMacroTargets"],
  ...
  },
  {
    ...
    functions: ["detectDehydrationRisk", "resolveHydrationPlan", "buildNutritionState"],
  ...
  },
  {
    ...
    functions: ["computeBodyMassTrend", "resolveScaleNoise"],
  ...
  },
  {
    ...
    functions: ["resolveCycleState", "detectCycleSafetyFlags", "estimateCycleConfidence"],
  ...
  },
  {
    ...
    functions: ["resolveAcuteProtocolEligibility", "resolveAcuteScaleStrategy"],
  ...
  },
  {
    ...
    functions: ["resolveSessionDuration", "buildTrainingGenerationConstraints", "recommendTrainingProgression"],
  ...
  },
  {
    ...
    functions: ["estimateMacroTargets", "buildSessionFuelingAdvice"],
  ...
  },
  {
    ...
    functions: ["resolveFightWeekFuelPlan", "resolveSodiumFiberStrategy", "resolveRehydrationPlan", "resolveTournamentFuelPlan"],
