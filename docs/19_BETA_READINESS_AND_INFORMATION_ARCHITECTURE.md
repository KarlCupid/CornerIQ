...
| Expo/EAS readiness | RC documented | `eas.json`, `npm run preflight:beta`, release-candidate checklist, and EAS distribution runbook exist. No actual EAS build has been run yet. |
